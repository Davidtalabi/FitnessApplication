<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoseWeight.aspx.cs" Inherits="WebApplication4.LoseWeight" %>
...
<h3 class="auto-style1">Your Weekly Workout Plan</h3>
    ...
    <form id="form1" runat="server">
        ...
        <Columns>
        <asp:TemplateField HeaderText="Monday (Indoor Workouts 30 minutes of each)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Tuesday (Outdoor Workouts 30 minutes of each)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Thursday (Indoor Workouts 30 minutes of each)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
                <asp:Image ID="Image1" runat="server" Height="200px" ImageUrl='<%# "data:Image/jpg;base64," + Convert.ToBase64String((byte [])Eval("Thursday")) %>' Width="200px" />
                        ...
                        <asp:TemplateField HeaderText="Friday (Indoor Workouts 30 minutes of each)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
