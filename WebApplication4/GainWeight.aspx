<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GainWeight.aspx.cs" Inherits="WebApplication4.GainWeight" %>
...
<h3 class="auto-style1">Your Weekly Workout Plan</h3>
    ...
    <form id="form1" runat="server">
        ...
        <Columns>
        <asp:TemplateField HeaderText="Monday (Bicep Workouts)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Tuesday(Tricep Workouts)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Thursday (Forearm Workouts)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
                <asp:Image ID="Image1" runat="server" Height="200px" ImageUrl='<%# "data:Image/jpg;base64," + Convert.ToBase64String((byte [])Eval("Thursday")) %>' Width="200px" />
                        ...
                        <asp:TemplateField HeaderText="Friday (Calf Workouts)" HeaderStyle-CssClass="text-center">
            <ItemTemplate>
